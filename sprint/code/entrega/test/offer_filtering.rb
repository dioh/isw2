...
require "../lib/serviceimplementation/online/online_search_strategies"
require "../lib/entity/offer"
require "test/unit"
...
class TestFiltering < Test::Unit::TestCase
    ...
    def test_create_offers
        of1 = Offer.new "Belgrano", "Naranjas", 30, "kg"
        of2 = Offer.new "Saavedra", "Peras", 35, "kg"
    end
    ...
    def test_search_action
        ...
        filters = ff.get_filters_for search_params
        data = [(Offer.new "Belgrano", "Naranjas", 30, "kg"), (Offer.new "Belgrano", "Bananas", 57, "kg")]
