...
\end{itemize}
\uncover<6->{\textbf{Hecho:} Los m\'etodos formales son muy \'utiles para encontrar errores de manera temprana y pueden eliminar casi completamente algunas clases de errores}
\end{frame}
