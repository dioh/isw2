...
\begin{riesgo}{mucha carga en el uso del sistema}{lentitud de respuesta en la consulta de ofertas}
    ...
    \impacto{Crítico}
    \exposicion{Alta}
    \mitigacion{Generar una arquitectura que permita la alta disponibilidad del servicio utilizando $cachés$ distribuidos para minimizar la carga en cada servidor. Armar casos de tests específicos para detectar problemas de disponibilidad en el sistema.}
